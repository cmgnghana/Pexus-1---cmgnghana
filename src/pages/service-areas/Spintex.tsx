  ...
  return (
    <>
      <SEO 
        ...
        description="Pexus & Garage Services proudly serves Spintex with reliable, professional towing and vehicle recovery, available every day of the week, day or night. From minor breakdowns to accident recovery, our Accra-based team is ready to assist. We are fully licensed and insured, giving you peace of mind on the road. Call or WhatsApp us for immediate help in Spintex."
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="bg-white p-6 sm:p-8 md:p-12 rounded-[1px] border border-dark/10 shadow-sm mb-12">
            <p className="text-dark/80 mb-6 leading-relaxed text-lg">
              Pexus & Garage Services proudly serves Spintex with reliable, professional towing and vehicle recovery, available every day of the week, day or night. From minor breakdowns to accident recovery, our Accra-based team is ready to assist. We are fully licensed and insured, giving you peace of mind on the road. Call or WhatsApp us for immediate help in Spintex.
            </p>
