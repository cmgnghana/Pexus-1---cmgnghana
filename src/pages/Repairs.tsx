...
const REPAIR_SERVICES = [
  ...
  { icon: Zap, title: 'Car Batteries', desc: 'Battery testing, replacement,of premium battery brands for reliable starting power.', href: '/parts' },
      ...
      <section className="py-16 md:py-24 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-2xl bg-primary rounded-[1px] p-6 sm:p-8 md:p-12 shadow-2xl">
            ...
            <p className="text-dark/70 mb-8">Contact us today to schedule your repair or maintenance service.</p>
