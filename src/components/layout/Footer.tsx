    ...
    <footer className="bg-dark text-white/70 pt-16 sm:pt-20 pb-10 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 mb-14">
          ...
          <div className="space-y-6">
            ...
            <p className="text-white/85 text-sm sm:text-base leading-relaxed">
              Ghana's premier automotive partner for 24/7 rapid emergency towing, heavy vehicle recovery, certified garage repairs.
            </p>
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-6">
              <a href="https://facebook.com/pexus" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-accent hover:text-white transition-all text-white/80" aria-label="Facebook"><Facebook className="w-4 h-4" /></a>
              <a href="https://twitter.com/pexus" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-accent hover:text-white transition-all text-white/80" aria-label="Twitter"><Twitter className="w-4 h-4" /></a>
              <a href="https://instagram.com/pexus" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-accent hover:text-white transition-all text-white/80" aria-label="Instagram"><Instagram className="w-4 h-4" /></a>
              <a href="https://linkedin.com/company/pexus" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-accent hover:text-white transition-all text-white/80" aria-label="LinkedIn"><Linkedin className="w-4 h-4" /></a>
            </div>
          </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-white/80 font-medium">
          <p>&copy; {new Date().getFullYear()} Pexus &amp; Garage Services Ltd. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
