          ...
          {[
            ...
            return (
              <motion.div
                ...
                className="bg-[#FFFFFF] border border-white/10 p-7 rounded-[1px] hover:border-accent/40 hover:bg-[#FFFFFF] transition-all duration-300 group flex flex-col hover:-translate-y-1.5"
              >
