...
const CORE_SERVICES = [
  ...
  { 
    ...
    desc: 'Genuine OEM replacement parts and quality automotive accessories.', 
    icon: Battery, 
...
export default function Services() {
  return (
    <main className="pt-24 lg:pt-[104px]">
      <SEO title="Comprehensive Auto Services | Towing & Repairs | Pexus" description="Explore our full range of automotive services including 24/7 emergency towing, mechanical repairs, body works, car , and fleet management." canonical="/services" />
      ...
      <section className="relative h-[60vh] min-h-[500px] flex items-center bg-primary overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            From roadside emergencies to , repairs, and  - we've got every stage of your journey covered.
          </motion.p>
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <a href="tel:0597684860" className="bg-[#DB1919] hover:bg-[#DB1919]/90 text-white px-4 sm:px-8 py-4 font-bold transition-all shadow-xl flex items-center justify-center gap-2 rounded-full">
              <Phone className="w-5 h-5" /> Call for Repair
            </a>
            <a href="https://wa.me/233597684860" target="_blank" rel="noopener noreferrer" className="bg-[#192C2C] hover:bg-[#192C2C]/90 text-white px-4 sm:px-8 py-4 font-bold transition-all shadow-xl flex items-center justify-center gap-2 rounded-full">
              ...
              return (
                ...
                >
                  ...
                  <div className="p-6 sm:p-8 flex-1 flex flex-col relative z-10 bg-white">
                    <div className="absolute -top-10 right-6 sm:right-8 w-14 h-14 bg-[#192C2C] text-white rounded-xl flex items-center justify-center shadow-lg group-hover:bg-white group-hover:text-[#192C2C] transition-colors duration-300">
                    ...
                    <div className="mt-auto pt-4 border-t border-dark/10 space-y-3">
                      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                        <a href="tel:0597684860" className="flex-1 bg-[#DB1919] hover:bg-[#DB1919]/90 text-white text-center py-2.5 px-3 text-xs sm:text-sm font-bold transition-all shadow-sm flex items-center justify-center gap-1 min-h-[40px] rounded-full">
                        <Phone className="w-3.5 h-3.5" />
                        <span>Call for Repair</span>
                      </a>
                      <a href="https://wa.me/233597684860" target="_blank" rel="noopener noreferrer" className="flex-1 bg-[#192C2C] hover:bg-[#192C2C]/90 text-white text-center py-2.5 px-3 text-xs sm:text-sm font-bold transition-all shadow-sm flex items-center justify-center gap-1.5 min-h-[40px] rounded-full">
                        <MessageCircle className="w-3.5 h-3.5" />
                        <span>WhatsApp for Repair</span>
                      </a>
                      </div>
      ...
      <section className="py-16 md:py-24 bg-primary text-white text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/contact" className="bg-primary hover:bg-black text-white px-4 sm:px-8 py-4 font-bold transition-all shadow-xl flex items-center justify-center rounded-full">
              Contact Us
            </Link>
            <a href="tel:0597684860" className="bg-white hover:bg-dark/5 text-dark px-4 sm:px-8 py-4 font-bold transition-all shadow-xl flex items-center justify-center rounded-full">
              Call Now
            </a>
          </div>
        </div>
