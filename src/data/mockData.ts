...
export const HERO_SLIDES = [
  ...
  },
  {
    ...
    buttons: [
      { label: 'Call for Repair', primary: true, href: 'tel:0597684860', color: '#DB1919' },
      { label: 'WhatsApp for Repair', primary: false, href: 'https://wa.me/233597684860', color: '#192C2C' }
    ],
...
export const QUICK_ACTIONS = [
  ...
  { id: 4, title: 'Call for Repairs', description: 'Certified expert mechanics', icon: Wrench },
...
export const SERVICES = [
  ...
  { id: 3, title: '', desc: 'Wide range of vehicles for rent.', icon: Car, image: 'https://i.ibb.co/qV5D1J9/Image-13-Filters-maintenance.jpg' },
  { id: 4, title: '', desc: 'Quality new and used cars.', icon: Car, image: 'https://i.ibb.co/35NfN5Lx/Image-14-Suspension-Parts-maintenance.jpg' },
  { id: 5, title: 'Auto Repairs', desc: 'Comprehensive mechanical repairs. Buy Batteries available.', icon: Wrench, image: 'https://i.ibb.co/WpyLYZQk/Image-15-Car-Lightening-maintenance.jpg' },
  { id: 6, title: 'Preventive Maintenance', desc: 'Keep your car running smoothly, including advanced Vehicle Diagnostics.', icon: Settings, image: 'https://i.ibb.co/1YFx5jQV/Image-10-Engine-Oil-and-Fluids-Maintenance.jpg' },
