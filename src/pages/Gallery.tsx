...
const CATEGORIES = [
  'All', 'Towing Fleet', 'Workshop', 'Body Works', 'Team & Facilities'
];
...
export default function Gallery() {
  ...
  return (
    <main className="pt-24 lg:pt-[104px] min-h-screen bg-white">
      <SEO title="Our Work Gallery | Towing & Auto Repairs | Pexus" description="View our gallery showcasing successful vehicle recoveries, auto body restorations, repair works." canonical="/gallery" />
      ...
      <section className="relative bg-primary text-white py-16 md:py-24 lg:py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 text-center md:text-left">
          ...
          >
            A visual look at our towing fleet, workshop facilities, and completed repairs. Quality you can see.
          </motion.p>
        </div>
      ...
      <section className="py-12 md:py-20 bg-white border-t border-dark/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <a href="https://instagram.com/pexus" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 font-bold text-accent hover:text-accent transition-colors">
              @pexus <ArrowRight className="w-4 h-4" />
            </a>
          </div>
