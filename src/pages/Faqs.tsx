...
const FAQ_DATA = [
  ...
  { category: 'Fleet', q: 'Do fleet accounts get discounted rates?', a: 'Yes, fleet partners enjoy volume-based discounts on labor, parts, , and towing services.' },
...
export default function Faqs() {
  ...
  return (
    <main className="pt-24 lg:pt-[104px] min-h-screen bg-white">
      <SEO title="Frequently Asked Questions | Pexus" description="Find answers to common questions about our emergency towing, auto repair." canonical="/faqs" />
      ...
      <section className="relative bg-primary text-white py-16 md:py-24 lg:py-32 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            Find quick answers about our towing, repair, and parts services.
          </motion.p>
