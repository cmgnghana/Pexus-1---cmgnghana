...
const STEPS = [
  ...
  { step: '04', title: 'Ongoing Support', desc: 'Access 24/7 VIP assistance, priority workshop slots, and seamless .' },
      ...
      <section className="relative bg-primary text-white py-16 md:py-24 lg:py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
          ...
          <div className="max-w-3xl">
            ...
            >
              Comprehensive maintenance, towing, and management services designed for businesses that depend on their vehicles to drive revenue.
            </motion.p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {FLEET_SERVICES.map((service, idx) => {
              ...
              return (
                ...
                >
                  <div className="w-14 h-14 bg-[#192C2C] rounded-xl flex items-center justify-center mb-6 shadow-sm group-hover:bg-white transition-colors">
      ...
      <section className="py-12 md:py-20 bg-primary text-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact our dedicated corporate team today to discuss your fleet requirements and receive a customized proposal.
          </p>
