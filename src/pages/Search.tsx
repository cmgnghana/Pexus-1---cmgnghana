...
const SEARCH_INDEX = [
  {
    ...
    path: '/',
    type: 'page',
    excerpt: 'Pexus offers 24/7 towing, auto repairs, body works, , and car  in Ghana.',
    keywords: ['home', 'Pexus', 'auto services', 'ghana', 'accra']
  },
  {
  ...
  },
  {
    ...
    path: '/faqs',
    type: 'policy',
    excerpt: 'Find answers to common questions about our towing, repairs.',
  ...
  },
  {
    ...
    type: 'policy',
    excerpt: 'Read our general terms and conditions for using Pexus.',
        ...
        {!query.trim() && (
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4">
            <Link to="/towing" className="flex flex-col items-center justify-center p-6 bg-white rounded-[1px] border border-dark/5 hover:border-primary/50 hover:shadow-md transition-all group text-center gap-3">
              <div className="w-12 h-12 bg-[#192C2C] group-hover:bg-white rounded-full flex items-center justify-center text-white group-hover:text-[#192C2C] group-hover:scale-110 transition-transform">
