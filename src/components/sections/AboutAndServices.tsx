        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-slate-600 mb-6 text-base sm:text-lg leading-relaxed">
              With over 15 years of industry excellence, Pexus &amp; Garage Services is your premier partner for 24/7 emergency towing, heavy vehicle recovery, certified mechanical repairs, and premium car .
            </p>
