...
const DEPARTMENTS = [
  ...
  { name: 'Fleet & B2B', phone: '0597684860', email: 'official.pexus@gmail.com', icon: ShieldCheck },
];
...
export default function Contact() {
  ...
  return (
    <main className="pt-24 lg:pt-[104px] min-h-screen bg-white">
      <SEO title="Contact Us | 24/7 Auto Support & Towing | Pexus" description="Get in touch with Pexus for inquiries, service bookings, or emergency 24/7 towing assistance across Ghana." canonical="/contact" />
      ...
      <section className="relative bg-primary text-white py-12 md:py-20 lg:py-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            Reach out for towing, repairs, , , or general enquiries. Our dedicated team is ready to assist you.
          </motion.p>
        </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {CONTACT_OPTIONS.map((option, idx) => {
              ...
              return (
                ...
                >
                  <div className={cn("w-12 h-12 rounded-xl flex items-center justify-center mb-4 transition-colors", "bg-[#192C2C] text-white group-hover:bg-white group-hover:text-[#192C2C]")}>
                  ...
                  return (
                    <div key={idx} className="flex items-start gap-4 pb-6 border-b border-dark/10 last:border-0 last:pb-0">
                      <div className="w-10 h-10 bg-[#192C2C] rounded-xl flex items-center justify-center shrink-0 group-hover:bg-white transition-colors">
                        <Icon className="w-5 h-5 text-white group-hover:text-[#192C2C] transition-colors" />
                      </div>
                      <div>
      ...
      <section className="py-12 md:py-20 bg-primary text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="tel:0597684860" className="bg-primary hover:bg-black text-white px-4 sm:px-8 py-4 font-bold transition-all shadow-xl flex items-center gap-2 rounded-full">
              <Phone className="w-5 h-5" /> Call Now
            </a>
            <a href="https://wa.me/233597684860" target="_blank" rel="noopener noreferrer" className="bg-white hover:bg-dark/5 text-[#25D366] px-4 sm:px-8 py-4 font-bold transition-all shadow-xl flex items-center gap-2 rounded-full">
