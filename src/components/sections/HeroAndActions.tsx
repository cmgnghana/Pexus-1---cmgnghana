        ...
        {QUICK_ACTIONS.map((action, idx) => {
          ...
          return (
            ...
            >
              ...
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#192C2C] rounded-full flex items-center justify-center mb-3 sm:mb-4 group-hover:bg-white group-hover:shadow-md group-hover:shadow-accent/30 transition-all duration-300 shrink-0">
                  <Icon className="w-5 h-5 sm:w-6 sm:h-6 text-white group-hover:text-[#192C2C] transition-colors duration-300" />
                </div>
