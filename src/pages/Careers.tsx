...
const DEPARTMENTS = ['All', 'Towing & Recovery', 'Auto Repair', 'Body Works', 'Customer Support', 'Administration'];
...
const JOBS = [
  ...
  { 
    ...
    requirements: [
      'Previous experience in automotive customer service.',
...
export default function Careers() {
  ...
  return (
    <main className="pt-24 lg:pt-[104px] min-h-screen bg-white">
      <SEO title="Careers | Join the Pexus Team" description="Explore exciting career opportunities for mechanics, tow truck operators, and administrative staff at Pexus." canonical="/careers" />
