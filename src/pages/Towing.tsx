      ...
      <section className="py-12 md:py-20 bg-primary text-white text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <a href="tel:0597684860" className="w-full sm:w-auto bg-primary hover:bg-black text-white px-4 sm:px-8 py-5 font-bold transition-all shadow-xl flex items-center justify-center gap-3 text-lg rounded-full">
