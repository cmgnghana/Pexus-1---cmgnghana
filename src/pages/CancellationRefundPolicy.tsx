...
export default function CancellationRefundPolicy() {
  return (
    <div className="pt-24 pb-16 md:pb-20 bg-slate-50 min-h-screen">
      <SEO title="Cancellation & Refund Policy | Pexus" description="Understand our policies regarding cancellations, refunds, and rescheduling for auto services, , and parts." canonical="/cancellation-refund-policy" />
