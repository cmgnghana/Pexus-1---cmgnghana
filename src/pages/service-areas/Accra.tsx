  ...
  return (
    <>
      <SEO 
        ...
        description="Looking for a dependable tow truck in Accra? Pexus & Garage Services has you covered with emergency towing, accident recovery, and roadside support, any time of day or night. Backed by our regional Accra dispatch team, we respond quickly to calls in and around Accra, with the option for long-distance towing when needed. Reach out now for fast, professional service."
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="bg-white p-6 sm:p-8 md:p-12 rounded-[1px] border border-dark/10 shadow-sm mb-12">
            <p className="text-dark/80 mb-6 leading-relaxed text-lg">
              Looking for a dependable tow truck in Accra? Pexus & Garage Services has you covered with emergency towing, accident recovery, and roadside support, any time of day or night. Backed by our regional Accra dispatch team, we respond quickly to calls in and around Accra, with the option for long-distance towing when needed. Reach out now for fast, professional service.
            </p>
