  ...
  return (
    <>
      <SEO 
        ...
        description="Pexus & Garage Services handles long-distance towing between Mampong and Accra with a licensed, insured, and experienced team. Whether it's a breakdown, accident, or scheduled transport, we get your vehicle safely from Mampong to Accra. Call or WhatsApp us now for a quote and fast dispatch."
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="bg-white p-6 sm:p-8 md:p-12 rounded-[1px] border border-dark/10 shadow-sm mb-12">
            <p className="text-dark/80 mb-6 leading-relaxed text-lg">
              Pexus & Garage Services handles long-distance towing between Mampong and Accra with a licensed, insured, and experienced team. Whether it's a breakdown, accident, or scheduled transport, we get your vehicle safely from Mampong to Accra. Call or WhatsApp us now for a quote and fast dispatch.
            </p>
